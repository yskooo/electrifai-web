...
const Team = () => {
  const teamMembers = [
    ...
    },
    {
      ...
      role: 'CTO, Developer',
      description: 'Leads the development of the app infrastracture, ensuring that the platform is secure, scalable, and efficient.',
      imgSrc: '',
     },
     {
  ...
  return (
    <section
      id="OurTeam"
      className="w-full py-12 md:py-20 lg:py-10 bg-gradient-to-b from-[#eef2f3] to-[#ffffff] flex items-center justify-center overflow-hidden"
    >
      <div className="container px-4 md:px-6 max-w-[1300px]">
        {/* Section Header */}
        <div className="text-center mb-8 md:mb-12 lg:mb-16">
          <h2 className="text-2xl sm:text-3xl lg:text-4xl font-extrabold tracking-tighter text-[#0A0A0B] mb-4">
            Meet Our Team
          </h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6 px-4 md:px-0">
          {teamMembers.map((member, index) => (
            <motion.div
              ...
              className="p-4 md:p-6 lg:p-4 rounded-xl md:rounded-2xl shadow-lg bg-white hover:shadow-2xl transition-shadow duration-300 transform text-center flex flex-col items-center"
            >
              {/* Profile Image with Decorative Elements */}
              <div className="relative mb-4">
                <div className="w-24 h-24 md:w-28 md:h-28 rounded-full overflow-hidden border-2 md:border-4 border-[#004aad] relative bg-[#eef2f3]">
                  <Image
                ...
                {/* Decorative Leaves / Elements around the Image */}
                <div className="absolute -bottom-2 -right-2 h-4 w-4 bg-[#2F4BE5] rounded-full"></div>
                <div className="absolute -bottom-2 -left-2 h-4 w-4 bg-[#2F4BE5] rounded-full"></div>
              </div>

              {/* Member Info */}
              <h3 className="text-sm md:text-lg lg:text-md font-bold text-[#0A0A0B] mb-1">{member.name}</h3>
              <h4 className="text-xs md:text-sm lg:text-xs font-medium text-[#2F4BE5] mb-2">{member.role}</h4>
