      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="space-y-4">
            <h3 className="text-lg font-semibold mb-4">ElectrifAI</h3>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              <li>
                <a href="/" className={`text-sm ${mutedText} hover:text-white transition-colors duration-200`}>
                  Home
                </a>
              </li>
              <li>
                <a href="/about" className={`text-sm ${mutedText} hover:text-white transition-colors duration-200`}>
                  About Us
                </a>
              </li>
              <li>
                <a href="/products" className={`text-sm ${mutedText} hover:text-white transition-colors duration-200`}>
                  Products
                </a>
              </li>
              <li>
                <a href="/solutions" className={`text-sm ${mutedText} hover:text-white transition-colors duration-200`}>
                  Solutions
                </a>
              </li>
            </ul>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              <li>
                <a href="/awards" className={`text-sm ${mutedText} hover:text-white transition-colors duration-200`}>
                  Awards
                </a>
              </li>
              <li>
                <a href="/research" className={`text-sm ${mutedText} hover:text-white transition-colors duration-200`}>
                  Research
                </a>
              </li>
              <li>
                <a href="/careers" className={`text-sm ${mutedText} hover:text-white transition-colors duration-200`}>
                  Careers
                </a>
              </li>
              <li>
                <a href="/#contact" className={`text-sm ${mutedText} hover:text-white transition-colors duration-200`}>
                  Contact Us
                </a>
              </li>
            </ul>
          ...
          {/* Connect With Us */}
          <div className="space-y-4">
            <h4 className="text-sm font-semibold mb-4 uppercase tracking-wider">Connect With Us</h4>
        ...
        <div className="pt-8 border-t border-white/20">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-sm text-center md:text-left">
              &copy; 2025 ElectrifAI Philippines Solutions Corp. All rights reserved.
            </p>
            <div className="flex gap-6 text-sm">
              <a href="/privacy" className={`${mutedText} hover:text-white transition-colors duration-200`}>
                Privacy Policy
              </a>
              <a href="/terms" className={`${mutedText} hover:text-white transition-colors duration-200`}>
                Terms of Service
              </a>
            </div>
          </div>
